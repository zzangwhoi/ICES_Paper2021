...
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_12_globc_1998_2013.mat')
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_34_globc_1998_2013.mat')
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_56_globc_1998_2013.mat')
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_78_globc_1998_2013.mat')
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_910_globc_1998_2013.mat')
load('/Users/zhengchenzang/Documents/monthly_globcolour/chl_1112_globc_1998_2013.mat')
...
for month = 1 : 6
    ...
    switch month
        case 1
            Data4plot=chl_12_globc;     Data4plot(Data4plot>6)=6;
        case 2
            Data4plot=chl_34_globc;     Data4plot(Data4plot>6)=6;
        case 3
            Data4plot=chl_56_globc;     Data4plot(Data4plot>6)=6;       
        case 4
            Data4plot=chl_78_globc;     Data4plot(Data4plot>6)=6;      
        case 5
            Data4plot=chl_910_globc;    Data4plot(Data4plot>6)=6;
        case 6
            Data4plot=chl_1112_globc;   Data4plot(Data4plot>6)=6;      
    end
...
colormap jet
 ...
 annotation('textbox',[0.15 0.87 0.9 0.1],'String','GlobColour bimonthly chlorophyll concentration (mg/m^3)','edgecolor','none','fontsize',16);
...
%
saveas(gcf,'Bimonthly_Chl_globcolour_noPbury.png')

save Bimonthly_chl_v10_zzang_globcolour chl_12_globc chl_34_globc chl_56_globc chl_78_globc chl_910_globc chl_1112_globc
