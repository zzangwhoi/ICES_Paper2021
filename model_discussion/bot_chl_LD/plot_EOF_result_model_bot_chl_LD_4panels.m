%% EOF input from /volumes/datastor/zzang1/Gbank/ on comsrv2
clc;clear
...
load(['../bot_chl/M_model_8days_chl_bot_1978_2014.mat'])
load(['../bot_chl/P_model_8days_chl_bot_1978_2014.mat'])
load(['../bot_chl/r_model_8days_chl_bot_1978_2014.mat'])
M_model_chl=M_model;
P_model_chl=P_model;
r_model_chl=r_model;

load(['../bot_LD/M_model_8days_LD_bot_1978_2014.mat'])
load(['../bot_LD/P_model_8days_LD_bot_1978_2014.mat'])
load(['../bot_LD/r_model_8days_LD_bot_1978_2014.mat'])
M_model_LD=M_model;
P_model_LD=P_model;
r_model_LD=r_model;
...
hold on
freezeColors
title(['a. Mode 1 (Chl)'],'fontsize',16)
text(-67,39,['(',num2str(r_model_chl(1)),'%)'],'fontsize',16)
...
hold on
freezeColors
title(['b. Mode 1 (LD)'],'fontsize',16)
text(-67,39,['(',num2str(r_model_LD(1)),'%)'],'fontsize',16)
...
title(['c. Mode 2 (Chl)'],'fontsize',16)
text(-67,39,['(',num2str(r_model_chl(2)),'%)'],'fontsize',16)

Data4plot=P_model_chl(mod2,:);
...
title(['d. Mode 2 (LD)'],'fontsize',16)
text(-67,39,['(',num2str(r_model_LD(2)),'%)'],'fontsize',16)

Data4plot=P_model_LD(mod2,:);
...
%%%%% tseries 1 %%%%%
ax2 = axes;
plot(M_model_chl(mod1,:)./-120,'k','linewidth',2);
...
%%%%% tseries 2 %%%%%
ax3 = axes;
plot(M_model_LD(mod1,:)./120,'k','linewidth',2);
...
%%%%% tseries 3 %%%%%
ax4 = axes;
plot(M_model_chl(mod2,:)./-120,'k','linewidth',2)
...
%%%%% tseries 4 %%%%%
ax5 = axes;
plot(M_model_LD(mod2,:)./80,'k','linewidth',2)
...
saveas(gcf,['model_bot_chl_LD_EOF',period,'_4panels.png'])
